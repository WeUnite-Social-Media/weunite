package com.weunite.api.common.mail.service;
...
public class EmailService {
  ...
  public void sendEmail(
      String to, String subject, String template, Map<String, Object> templateVars) {
    try {
  ...
  private String replaceTemplateVariables(String template, Map<String, Object> templateVars) {
    ...
    for (Map.Entry<String, Object> entry : templateVars.entrySet()) {
      ...
      result =
          result.replace(placeholder, entry.getValue() != null ? entry.getValue().toString() : "");
    }
    return result;
  }
  ...
  @Async
  public void sendVerificationEmailClub(
      String to, String cnpj, String name, String username, String email) {
    Map<String, Object> templateVars = new HashMap<>();
