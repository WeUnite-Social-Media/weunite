package com.weunite.api.common.storage.service;

import com.cloudinary.Cloudinary;
import com.cloudinary.Transformation;
import com.weunite.api.common.config.CloudinaryImageProperties;
...
public class CloudinaryService {
  ...
  public String getImageWithHeight(String publicId, int height) {
    return cloudinary
        .url()
        .transformation(
            new Transformation().height(height).crop("limit").quality("auto").fetchFormat("auto"))
        .generate(publicId);
  }
