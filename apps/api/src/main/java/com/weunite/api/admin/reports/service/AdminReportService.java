...
public class AdminReportService {
  ...
  public ReportedPostDetailDTO getReportedPostDetail(Long postId) {
    ...
    List<Report> reports =
        reportRepository.findByTargetAndStatus(
            targetFor(Report.ReportType.POST, postId), Report.ReportStatus.PENDING);
  ...
  public ResponseDTO<PostDTO> deletePostByAdmin(Long postId) {
    ...
    List<Report> reports = reportRepository.findByTarget(targetFor(Report.ReportType.POST, postId));
    reports.forEach(
        report -> {
  ...
  public ReportedOpportunityDetailDTO getReportedOpportunityDetail(Long opportunityId) {
    ...
    List<Report> reports =
        reportRepository.findByTargetAndStatus(
            targetFor(Report.ReportType.OPPORTUNITY, opportunityId), Report.ReportStatus.PENDING);
  ...
  public ResponseDTO<OpportunityDTO> deleteOpportunityByAdmin(Long opportunityId) {
    ...
    // Marcar todas as denuncias relacionadas como RESOLVED (pois o conteudo foi removido)
    List<Report> reports =
        reportRepository.findByTarget(targetFor(Report.ReportType.OPPORTUNITY, opportunityId));
    reports.forEach(
        report -> {
          report.setStatus(Report.ReportStatus.RESOLVED);
          report.setActionTaken(Report.ActionTaken.CONTENT_REMOVED);
  ...
  public ReportedCommentDetailDTO getReportedCommentDetail(Long commentId) {
    ...
    List<Report> reports =
        reportRepository.findByTargetAndStatus(
            targetFor(Report.ReportType.COMMENT, commentId), Report.ReportStatus.PENDING);
  ...
  public ResponseDTO<CommentDTO> deleteCommentByAdmin(Long commentId) {
    ...
    // Marcar todas as denuncias relacionadas como RESOLVED (pois o conteudo foi removido)
    List<Report> reports =
        reportRepository.findByTarget(targetFor(Report.ReportType.COMMENT, commentId));
    reports.forEach(
        report -> {
          report.setStatus(Report.ReportStatus.RESOLVED);
          report.setActionTaken(Report.ActionTaken.CONTENT_REMOVED);
  ...
  private ReportTarget targetFor(Report.ReportType reportType, Long entityId) {
    return new ReportTarget(reportType, entityId);
  }
