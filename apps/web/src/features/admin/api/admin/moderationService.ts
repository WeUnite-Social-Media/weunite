...
export const moderatePostRequest = async (
  ...
  switch (action.action) {
    case "hide":
      return hidePostRequest(action.entityId, action.reason);
    case "delete":
      return deletePostRequest(action.entityId, action.reason);
    case "dismiss":
      return dismissReportRequest(action.entityId, action.reason);
    default:
      return {
        success: false,
        data: null,
