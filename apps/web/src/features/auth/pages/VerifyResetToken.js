...
function VerifyResetToken() {
    ...
    var verifyResetToken = (0, useAuthStore_1.useAuthStore)().verifyResetToken;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, verifyResetToken(values, email)];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
                            navigate("/auth/reset-password/".concat(values.verificationToken));
                        }
                        return [3 /*break*/, 3];
                    case 2:
    ...
    return (<div className="flex items-center justify-center min-h-screen p-4">
      <card_1.Card className="w-[380px] max-w-full">
        <card_1.CardHeader className="space-y-2">
          <button className="flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground cursor-pointer transition-colors" onClick={function () { return navigate("/auth/send-reset-password"); }}>
