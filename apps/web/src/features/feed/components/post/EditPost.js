...
function EditPost(_a) {
    var open = _a.open, onOpenChange = _a.onOpenChange, post = _a.post;
    ...
    var updatePostMutation = (0, usePosts_1.useUpdatePost)();
                ...
                switch (_a.label) {
                    case 0:
                        if (!(user === null || user === void 0 ? void 0 : user.id))
                            return [2 /*return*/];
                        return [4 /*yield*/, updatePostMutation.mutateAsync({
                                data: {
                                    text: values.text,
                                    media: values.media,
                                },
                                userId: Number(user.id),
                                postId: Number(post === null || post === void 0 ? void 0 : post.id),
                            })];
                    case 1:
                        result = _a.sent();
                        if (result.success) {
    ...
    var isSubmitting = updatePostMutation.isPending;
    return (<dialog_1.Dialog open={open} onOpenChange={onOpenChange}>
      <dialog_1.DialogContent className="sm:max-w-[500px]" aria-describedby={undefined}>
        <dialog_1.DialogHeader>
          <dialog_1.DialogTitle>Editar publicação</dialog_1.DialogTitle>
        </dialog_1.DialogHeader>
