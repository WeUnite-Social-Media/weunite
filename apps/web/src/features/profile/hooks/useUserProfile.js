...
var useUserProfile = function (username) {
    var authUser = (0, useAuthStore_1.useAuthStore)().user;
    var isOwnProfile = !username || username === (authUser === null || authUser === void 0 ? void 0 : authUser.username);
    return (0, react_query_1.useQuery)({
        ...
        queryFn: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, userService_1.getUserByUsername)(username)];
                    case 1:
                        result = _a.sent();
                        if (!result.success) {
