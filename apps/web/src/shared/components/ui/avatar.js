...
function Avatar(_a) {
    ...
    return (<AvatarPrimitive.Root data-slot="avatar" className={(0, utils_1.cn)("relative flex size-8.5 shrink-0 overflow-hidden rounded-full cursor-pointer", className)} {...props}/>);
}
