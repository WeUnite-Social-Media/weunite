...
function TabsList(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<TabsPrimitive.List data-slot="tabs-list" className={(0, utils_1.cn)("bg-background text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]", className)} {...props}/>);
}
