...
exports.getTimeDisplayProps = exports.formatChatTime = void 0;
...
var getTimeDisplayProps = function (time, unread) {
    var isRecent = time.includes(":") || time.toLowerCase() === "agora";
    return {
        textClass: unread > 0 && isRecent
...
exports.getTimeDisplayProps = getTimeDisplayProps;
