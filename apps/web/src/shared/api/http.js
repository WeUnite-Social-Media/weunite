...
var apiBaseUrl = ((_a = import.meta.env.VITE_API_URL) === null || _a === void 0 ? void 0 : _a.trim()) || "/api";
exports.instance = axios_1.default.create({
    baseURL: apiBaseUrl,
});
// Interceptor para adicionar o token JWT em todas as requisições
exports.instance.interceptors.request.use(function (config) {
    var jwt = useAuthStore_1.useAuthStore.getState().jwt;
    if (jwt) {
...
exports.instance.interceptors.response.use(function (response) { return response; }, function (error) { return __awaiter(void 0, void 0, void 0, function () {
    var originalRequest;
    var _a, _b;
    return __generator(this, function (_c) {
        ...
        if (((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) === 401 &&
            ...
            !((_b = originalRequest.url) === null || _b === void 0 ? void 0 : _b.includes("/auth/login"))) {
