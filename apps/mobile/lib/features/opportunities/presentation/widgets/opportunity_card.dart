        ...
        return ListView(
          ...
          children: [
            ...
            if (onToggleSubscription != null) ...[
              ...
              if (opportunity.isSubscribed)
                OutlinedButton.icon(
                  onPressed: isPending ? null : onToggleSubscription,
                  icon: const Icon(Icons.check_circle_outline),
                  label: Text(
                    isPending ? 'Enviando...' : 'Candidatura enviada',
                  ),
                )
              else
                ElevatedButton(
                  onPressed: isPending || closed ? null : onToggleSubscription,
                  child: Text(
                    closed
              ...
              if (opportunity.isSubscribed)
                const Padding(
                  ...
                  child: Text(
                    'Toque no botao para cancelar sua candidatura.',
